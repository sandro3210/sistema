...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('paises.index')); ?>">
                <i class="fas fa-fw fa-globe"></i>
                <span><?php echo e(__('Paises')); ?></span>
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('inquilinos.index')); ?>">
                <i class="fas fa-fw fa-users"></i>
                <span><?php echo e(__('Inquilinos')); ?></span>
            </a>
        </li>

        <!--Departamento -->
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('departamentos.index')); ?>">
                <i class="fas fa-fw fa-users"></i>
                <span><?php echo e(__('departamento')); ?></span>
            </a>
        </li>
        <!--Alquiler -->
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('alquileres.index')); ?>">
                <i class="fas fa-fw fa-users"></i>
                <span><?php echo e(__('alquiler')); ?></span>
            </a>
        </li>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; <a href="https://github.com/aleckrh" target="_blank">Aleckrh</a> <?php echo e(now()->year); ?></span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
...
<?php /**PATH C:\Users\ASUS\RelacionesTablas\resources\views/layouts/admin.blade.php ENDPATH**/ ?>